...
public class Class1 {
    ...
    private static void dataType() {
        // 一个字节, 有符号8位, 最大值为pow(2, 7) - 1 = 127
        byte a = 127;
        // 一个字节, 8位
        boolean i = false;

        // 两个字节, 有符号16位, 最大值为pow(2, 15) - 1 = 32767
        short b = 32767;
        // 两个字节, 无符号16位, 最大值位pow(2, 16) - 1 = 65536
        char e = 65535;

        // 四个字节, 有符号32位
        int c = 2147483647;
        // 四个字节, 有符号32位, 1位符号位, 8位指数位, 23位尾数位
        float f = -111111111111111111111111111111111111111F;

        // 八个字节, 有符号64位
        long d = 1111111111111111111L;
        // 八个字节, 有符号64位, 1位符号位, 11位指数位, 52位尾数位
